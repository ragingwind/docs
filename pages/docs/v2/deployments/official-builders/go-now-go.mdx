...
All major Git providers are supported including GitHub, GitLab, Bitbucket, as well as self-host Git server.

With GitHub, you will need to create personal token with permission to access your private repository. [Generate new token](https://github.com/settings/tokens)
